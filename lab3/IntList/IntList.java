...
public class IntList {
    ...
    private static IntList reverseHelper(IntList L) {
        if (L == null || L.tail == null) {
            ...
            //reversed now holds the tail of the list but reversed
            IntList reversed = reverseHelper(L.tail);
            //fix pointers so that the front node of the list becomes the end
            L.tail.tail = L;
            L.tail = null;
            return reversed;
        }
